...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('database', default_value='~/.ros/motus_slam_nav.db'),
    ...
    rtabmap_args = (
        ...
        '--RGBD/LinearUpdate 0.08 --RGBD/AngularUpdate 0.08 '
    ...
    return LaunchDescription(args + [phone, safety, car, rviz, web_nav, rtabmap, nav2])
